...
struct VoxMaterial {
  ...
  bool operator==(const VoxMaterial &other) {
    if (type != other.type || weight != other.weight || rough != other.rough ||
        spec != other.spec || ior != other.ior || att != other.att ||
        flux != other.flux || plastic != other.plastic)
      return false;
...
public:
  ...
  bool decodeChunk(const std::string &chunkName, const uint8_t *content,
                   unsigned int size);
